...
const Projects: React.FC = () => {
  ...
  return (
    <section id="projects" className="min-h-screen bg-dark py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          {filteredProjects.map((project, index) => (
            ...
            >
              {/* 项目卡片 */}
              <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-800 hover:border-primary-500/50 transition-all duration-300">
                {/* 封面图区域 */}
